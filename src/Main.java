...
public class Main {
    ...
    public static void main(String[] args) throws ParserConfigurationException, IOException, SAXException, TransformerException {
        ...
        try{
            ...
            Document document = builder.parse(new File("C:\\Users\\Julio\\OneDrive - Universidad de Sonora\\Ingenieria En Sistemas De Informacion\\Semestre 3\\Desarrollo de sistemas lll\\Proyectos IntelliJ\\Api-XML-Dom\\src\\sales.xml"));
            ...
            // Solicitar el porcentaje de incremento al usuario

            System.out.println("Departamentos: Health, Computers, Sports, Music, Movies, Electronics, \nGarden, Toys,  Tools, Home, Books, Industrial, Automotive, Baby, \n Outdoors, Jewerly, Kids, Beauty, Clothing, Games, Shoes, Grocery \n");
            System.out.print("Ingrese el nombre del departamento");
            String departamento = sc.nextLine().trim(); // trim () en java elimina los espacios en blanco en ambos extremos del string.
            ...
            // Crear un transformador para generar el nuevo documento XML

            TransformerFactory transformerFactory = TransformerFactory.newInstance();
            Transformer transformer = transformerFactory.newTransformer();
            DOMSource source = new DOMSource(document);
            StreamResult result = new StreamResult(new File("sales_modificado.xml"));
